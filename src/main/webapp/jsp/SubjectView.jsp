...
<body>
    <form action="SubjectCtl" method="POST">
        ...
        <jsp:useBean id="bean" class="in.com.rays.proj4.bean.SubjectBean" scope="request"></jsp:useBean>
        ...
        <div align="center">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="name" placeholder="Enter Course Name" value="<%=ServletUtility.getParameter("name", request)%>">&emsp;
                    </td>
                    <td style="position: fixed;">
                        <font color="red">
