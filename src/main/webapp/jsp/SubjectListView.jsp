	...
	<div align="center">
		...
		<form action="<%=ORSView.SUBJECT_LIST_CTL%>" method="post">
			...
			<table style="width: 100%">
				<tr>
					<td align="center"><label><b>Subject Name :</b></label> <input type="text" name="name" placeholder="Enter Subject Name" value="<%=ServletUtility.getParameter("name", request)%>">&emsp;
						<label><b>Course Name :</b></label> <input type="text" name="name" placeholder="Enter Course Name" value="<%=ServletUtility.getParameter("name", request)%>">&emsp;
